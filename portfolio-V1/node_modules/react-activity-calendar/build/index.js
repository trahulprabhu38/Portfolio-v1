...
const ActivityCalendar$1 = /*#__PURE__*/react.forwardRef(({
  data: activities,
  blockMargin = 4,
  blockRadius = 2,
  blockSize = 12,
...
ref) => {
  ...
  const weekdayLabelOffset = weekdayLabels.shouldShow ? maxWeekdayLabelWidth(labels.weekdays, weekdayLabels, fontSize) + LABEL_MARGIN : undefined;
...
const Skeleton = props => /*#__PURE__*/jsxRuntime.jsx(ActivityCalendar$1, {
  data: [],
  ...props
});
...
function ActivityCalendar(props) {
  ...
  return isClient ? /*#__PURE__*/jsxRuntime.jsx(ActivityCalendar$1, {
    ...props
  }) : null;
}
